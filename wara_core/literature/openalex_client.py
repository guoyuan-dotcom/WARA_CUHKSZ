...
_POLITE_EMAIL = "wara@users.noreply.github.com"
_MAX_PER_REQUEST = 50
_MAX_RETRIES = int(os.environ.get("WCL_OPENALEX_MAX_RETRIES", "2"))
_MAX_WAIT_SEC = int(os.environ.get("WCL_OPENALEX_MAX_WAIT_SEC", "8"))
        ...
        try:
            req = urllib.request.Request(
                ...
                headers={
                    ...
                    "User-Agent": f"WARA/1.0 (mailto:{email})",
                },
            )
